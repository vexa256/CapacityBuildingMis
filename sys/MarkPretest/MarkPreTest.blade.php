...
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {!! Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Manage all UnMarked Pre Test Assessments', $Msg = null) !!}
</div>
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
                    ...
                    <div class="modal-header bg-gray">
                        <h5 class="modal-title"> SRL Uganda |
                            ...
                            <span class="text-danger">
                                ...
                                {{ $post->Name }} . | The Course is {{ $CourseName }}
...
@include('MarkPretest.PreTestAns')
@include('MarkPretest.ScorePreTest')
@include('MarkPretest.Guide')
@include('MarkPretest.Results')
