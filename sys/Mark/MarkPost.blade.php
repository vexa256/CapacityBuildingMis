...
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {!! Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Manage all UnMarked Post Test Assessments', $Msg = null) !!}
</div>
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
...
@include('Mark.PostAns')
@include('Mark.ScorePost')
@include('Mark.Guide')
@include('Mark.Results')
