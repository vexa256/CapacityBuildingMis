...
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
    {!! Alert($icon = 'fa-info', $class = 'alert-primary', $Title = 'Manage all UnMarked Practical Tests For ' . $Module, $Msg = null) !!}
</div>
<div class="card-body pt-3 bg-light shadow-lg table-responsive">
...
@include('MarkPractical.PracticalAns')
@include('MarkPractical.ScorePractical')
@include('MarkPractical.Guide')
@include('MarkPractical.Results')
